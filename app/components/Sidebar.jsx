...
export default function Sidebar() {
    ...
    return (
        <div className="bg-gray-900 text-white min-h-screen">
            ...
            {/* Sidebar */}
            <div
                className={`bg-gray-900 border-r border-gray-800 w-3/4 transform transition-transform duration-300 md:w-64
            ...
            >
                ...
                <nav className="space-y-2 px-4 py-4">
                    ...
                    <Link
                        href="/"
                        className="hidden md:flex items-center mt-1.5 pb-6 space-x-2 p-2 hover:bg-gray-700 rounded"
                    >
                    ...
                    <Link
                        href="/"
                        className="flex items-center text-sm space-x-2 p-2 hover:bg-gray-700 rounded"
                    >
